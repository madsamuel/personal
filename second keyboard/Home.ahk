...
~F24::
FileRead, key, C:\Users\stefang\home_keypressed.txt
...
;	Process, Exist, OUTLOOK.exe
	If (!ErrorLevel){
		Run "C:\Program Files (x86)\K-Lite Codec Pack\MPC-HC64\mpc-hc64.exe"             
;		WinWait, ahk_exe "C:\Program Files (x86)\K-Lite Codec Pack\MPC-HC64\mpc-hc64.exe"
	}
}
else if(key = "v") {
;	Process, Exist, OUTLOOK.exe
...
;		WinWait, ahk_exe "C:\Program Files (x86)\Microsoft VS Code\Code.exe"
	}
}	
else if(key = "p")
